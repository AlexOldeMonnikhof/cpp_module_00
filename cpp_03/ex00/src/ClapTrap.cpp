...
ClapTrap::ClapTrap() : name("unnamed"), hp(10), energy(10), dmg(0)
{
...
void	ClapTrap::attack(const std::string& target)
{
	if (hp > 0 && energy > 0)
	{
		...
		std::cout << name << " can not attack due to no hit points!" << std::endl;
	else
		std::cout << name << " can not attack due to no energy points!" << std::endl;
}
